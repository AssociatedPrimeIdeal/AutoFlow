...
5. update the matching English docs pages
...
6. update docs in `docs/en/user/gui.md` and the relevant feature page
7. run the retained smoke and phantom regression suite when needed
...
3. document the file in `docs/en/user/outputs.md`
...
5. update segmentation docs in English
